...
@interface BT_XTCycleScrollView ()<UIScrollViewDelegate>
{
...
@property (nonatomic , strong) BT_XTPageControl *pageControl;

@end

@implementation BT_XTCycleScrollView

- (BT_XTPageControl *)pageControl
{
    ...
    if (self.totalPageCount > 1) {
        if (!_pageControl) {
            ...
            UIImage *normalDotImage = [UIImage imageWithColor:[UIColor colorWithHexString:@"#434a54"] size:CGSizeMake(8, 8)];
            UIImage *highlightDotImage = [UIImage imageWithColor:[UIColor colorWithHexString:@"#ffffff"] size:CGSizeMake(8, 8)];
            ...
            _pageControl = [[BT_XTPageControl alloc] initWithFrame:pageControlFrame
