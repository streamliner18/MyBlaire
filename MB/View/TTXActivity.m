...
@property (nonatomic,assign) id<TTXActivityDelegate>delegate;

@end

@implementation TTXActivity
    ...
    if (shareButtonImagesNameArray) {
        if (shareButtonImagesNameArray.count > 0) {
            ...
            for (int i = 1; i < shareButtonImagesNameArray.count+1; i++) {
                ...
                [shareButton setBackgroundImage:[UIImage bt_imageWithBundleName:@"Source" imageName:[shareButtonImagesNameArray objectAtIndex:i-1]] forState:UIControlStateNormal];
                //有Title的时候
